...
const styles = StyleSheet.create({
  ...
  recentPoster: { width: 80, height: 120, borderRadius: 8, backgroundColor: COLORS.card },
  recentTitle:  { fontSize: 10, color: COLORS.textSec, marginTop: 6, textAlign: 'center', width: 80 },
